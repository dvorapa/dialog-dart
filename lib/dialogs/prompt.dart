...
String prompt([String message = "", String value = ""]) {
  ...
  promptDialog
      ..showDialog()
      ..modalBackdrop.onClick.first.then(
          (_) => null).then((_) => promptDialog.closeDialog())
      ..xButton.onClick.first.then(
          (_) => null).then((_) => promptDialog.closeDialog())
      ..cancelButton.onClick.first.then(
          (_) => null).then((_) => promptDialog.closeDialog())
      ..okButton.onClick.first.then(
          (_) => input.value).then((_) => promptDialog.closeDialog());
  input.focus();
}
